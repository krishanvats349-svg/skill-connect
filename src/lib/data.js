...
export const navItems = {
  ...
  employer: [["overview", "Dashboard", "⌂"], ["create-consultation", "Create Consultation", "+"], ["consultations", "My Consultations", "▤"], ["required-skills", "Required Skills", "✦"], ["feedback", "Placement Feedback", "↗"]],
  institute: [["overview", "Dashboard", "⌂"], ["courses", "Courses", "▤"], ["course-skills", "Course Skills", "✦"], ["capacity", "Training Capacity", "▥"], ["placements", "Placement Outcomes", "↗"]],
...
export const initialData = {
  ...
  courses: [{ id: "course-1", instituteId: "pda", name: "Data Analytics Accelerator", duration: "12 weeks", seats: 40, enrolled: 28, mode: "Blended", status: "Active", skillIds: ["python", "sql", "data-analysis", "power-bi", "communication"] }, { id: "course-2", instituteId: "pda", name: "Business Intelligence Foundations", duration: "8 weeks", seats: 30, enrolled: 17, mode: "Classroom", status: "Active", skillIds: ["sql", "power-bi", "excel", "communication"] }],
  courseSkills: [{ id: "cs-1", courseId: "course-1", skillIds: ["python", "sql", "data-analysis", "power-bi", "communication"] }, { id: "cs-2", courseId: "course-2", skillIds: ["sql", "power-bi", "excel", "communication"] }],
  ...
  trainingInstitutes: [{ id: "pda", name: "Pune Digital Academy", district: "Pune", courses: 2, seats: 70, rating: 4.6 }],
...
export const normalizeData = (raw = initialData) => {
  ...
  return { ...initialData, ...raw, schemaVersion: 2, employers, consultations, curriculums, curriculumSkills };
};